...
def train(data_path,model_path,random_state,n_estimators,max_depth):
    ...
    mlflow.set_tracking_uri("https://dagshub.com/Arsid-Tarune/machinelearningpipeline.mlflow")
    ...
    with mlflow.start_run():
        ...
        try:
            ...
            print(f"Warning: Failed to register model with MLflow: {e}")
            # Skip MLflow model registration and just save locally
